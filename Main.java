...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Amount to be paid for " +burger.getName()+ " is "+burger.itemizeBurger()+"\n");
        ...
        System.out.println("Amount to be paid for " +healthyBurger.getName()+ " is "+healthyBurger.itemizeBurger()+"\n");

        DeluxeBurger deluxeBurger = new DeluxeBurger();
        deluxeBurger.addBurgerAddition3("Should not do this ",87.98);
        System.out.println("Amount to be paid for " +deluxeBurger.getName()+ " is "+deluxeBurger.itemizeBurger());
    }
}
